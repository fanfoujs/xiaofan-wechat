...
class User {
  constructor (user) {
    ...
    this.taEnd = this.is_me ? '我' : user.gender === '男' ? '他' : user.gender === '女' ? '她' : ' ta'
    this.taBegin = this.is_me ? '我' : user.gender === '男' ? '他' : user.gender === '女' ? '她' : 'ta '
    this.taMiddle = this.is_me ? '我' : user.gender === '男' ? '他' : user.gender === '女' ? '她' : ' ta '
  }
